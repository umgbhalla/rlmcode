...
import { MOCK_ORCH_TOOL, MOCK_RATELIMIT_TOOL, MOCK_TRANSCRIPT_TOOL } from "../core/mock.ts"
...
const defaultAgent =
  process.env.RLM_MOCK === "1"
    ? createAgent({ ai: makeMockAI(process.env.RLM_MOCK_STREAM === "1"), model: MOCK_MODEL, tools: [...BASE_TOOLS, MOCK_ORCH_TOOL, MOCK_TRANSCRIPT_TOOL, MOCK_RATELIMIT_TOOL] })
