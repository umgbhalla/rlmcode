...
export type Activity =
  ...
  | { readonly kind: "node"; readonly nodeId: string; readonly event: string; readonly parentId?: string; readonly detail?: string } // orchestration node lifecycle (orch.emit)
